...
const Main = () => {
   ...
   return (
    ...
    <div className='my-4'>
    <button className='border bg-gray-300  text-black border-gary-300 py-2 px-5'>play</button>
    <button className='border   text-white ml-1 border-gary-300 py-2 px-5'>Watch later</button>
    </div>
